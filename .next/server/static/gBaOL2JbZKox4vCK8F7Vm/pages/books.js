...
// CONCATENATED MODULE: ./frontend/components/BookForm/BookForm.js
...
var BookForm_BookForm = function BookForm(_ref) {
  ...
  var authorId = wrapProps.authorId;
  return external_react_default.a.createElement("div", {
    ...
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__name"
  }, "Author"), external_react_default.a.createElement("select", {
    onChange: function onChange(e) {
      selectHandler(e, "author");
    },
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__input"
    ...
    href: "/authors"
  })), mapFromCache(authorId.split(), client, "author", form_add["a" /* default */]), external_react_default.a.createElement("label", {
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__label"
  }, external_react_default.a.createElement("span", {
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__name"
  ...
  }, formType === "edit-book" ? "Save changes" : "Create book"), external_react_default.a.createElement("button", {
...
/* harmony default export */ var components_BookForm_BookForm = (Object(external_react_apollo_["compose"])(external_react_apollo_["withApollo"], Object(external_react_apollo_["graphql"])(queries["d" /* getAuthorsQuery */], {
  name: "getAuthorsQuery"
}), Object(external_react_apollo_["graphql"])(queries["f" /* getGenresQuery */], {
  name: "getGenresQuery"
}), Object(external_react_apollo_["graphql"])(queries["e" /* getBooksQuery */], {
  name: "getBooksQuery"
}), Object(external_react_apollo_["graphql"])(queries["b" /* addBookQuery */], {
  name: "addBookQuery",
  options: {
    refetchQueries: [{
      query: queries["e" /* getBooksQuery */]
    }]
  }
}), Object(external_react_apollo_["graphql"])(queries["k" /* updateBookQuery */], {
...
}))(Object(WithCRU["a" /* default */])(Object(external_react_apollo_["withApollo"])(BookForm_BookForm))));
// EXTERNAL MODULE: ./frontend/components/EmptyTable/EmptyTable.js
var EmptyTable = __webpack_require__(8);

// CONCATENATED MODULE: ./frontend/components/BooksTableEdit/BooksTableEdit.js
...
var BooksTableEdit_BooksTableEdit = function BooksTableEdit(_ref) {
  var id = _ref.id;
  return external_react_default.a.createElement("div", {
    ...
    var source = data.books.find(function (book) {
      return book.id === id;
    });
    ...
    }, "Book name"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Author name"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Genres")), source.length === 0 ? external_react_default.a.createElement(EmptyTable["a" /* default */], {
      name: "books",
      size: "3"
    }) : external_react_default.a.createElement("tr", {
      key: source.id,
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__content"
    }, external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, source.name), external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, source.author.name), source.genres.length === 0 ? external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash)
...
/* harmony default export */ var components_BooksTableEdit_BooksTableEdit = (BooksTableEdit_BooksTableEdit);
// EXTERNAL MODULE: ./frontend/components/WithDelete/WithDelete.js
var WithDelete = __webpack_require__(15);

// CONCATENATED MODULE: ./frontend/components/BooksTable/BooksTable.js
...
var BooksTable_BooksTable = function BooksTable(_ref) {
  ...
  return external_react_default.a.createElement("div", {
  ...
  }, "Books"), external_react_default.a.createElement(Popup["a" /* default */], {
    trigger: external_react_default.a.createElement("button", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__add"
    }, "Add book")
  }, external_react_default.a.createElement("div", {
    className: "jsx-".concat(table["a" /* default */].__hash)
  }, external_react_default.a.createElement(components_BookForm_BookForm, {
    formType: "add-book",
    defaultState: {
      name: "",
      authorId: "",
    ...
    return external_react_default.a.createElement("table", {
      ...
      name: "books",
      size: "4"
    }) : source.map(function (book) {
      return external_react_default.a.createElement("tr", {
        key: book.id,
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__content"
      }, external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, book.name), external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, book.author.name), book.genres.length === 0 ? external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, "no genres") : external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, external_react_default.a.createElement("table", {
        ...
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, external_react_default.a.createElement(components_BooksTableEdit_BooksTableEdit, {
        id: book.id
      }), external_react_default.a.createElement(components_BookForm_BookForm, {
        formType: "edit-book",
        defaultState: {
          ...
          genreIds: new Set(book.genres.map(function (genre) {
            return genre.id;
          })),
        ...
        onClick: function onClick(id, queryName) {
          deleteHandler(book.id, "removeBookQuery");
        },
...
/* harmony default export */ var components_BooksTable_BooksTable = (Object(external_react_apollo_["graphql"])(queries["h" /* removeBookQuery */], {
...
})(Object(WithDelete["a" /* default */])(BooksTable_BooksTable)));
// EXTERNAL MODULE: ./frontend/components/Layout/Layout.js
var Layout = __webpack_require__(12);

// CONCATENATED MODULE: ./pages/books.js





/* harmony default export */ var books = __webpack_exports__["default"] = (Object(WithData["a" /* default */])(function () {
  return external_react_default.a.createElement(Layout["a" /* default */], {
    title: "Books table"
  }, external_react_default.a.createElement(Header["a" /* default */], {
    id: "2"
  }), external_react_default.a.createElement(components_BooksTable_BooksTable, null));
}));
