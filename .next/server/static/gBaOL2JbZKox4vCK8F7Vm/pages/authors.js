...
var LinkCustom = function LinkCustom(_ref) {
  var href = _ref.href;
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    href: href
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
    className: "jsx-3715969836" + " " + "link"
...
// EXTERNAL MODULE: ./frontend/components/LinkCustom/LinkCustom.js
var LinkCustom = __webpack_require__(17);

// EXTERNAL MODULE: ./frontend/styles/form_add.js
var form_add = __webpack_require__(2);

// CONCATENATED MODULE: ./frontend/components/AuthorForm/AuthorForm.js
...
var AuthorForm_AuthorForm = function AuthorForm(_ref) {
  ...
  var influenceIds = Array.from(wrapProps.influenceIds);
  return external_react_default.a.createElement("div", {
    ...
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__name"
  }, "Genres"), external_react_default.a.createElement("select", {
    onChange: function onChange(e) {
  ...
  })), external_react_default.a.createElement(LinkCustom["a" /* default */], {
    href: "/genres"
  })), mapFromCache(genreIds, client, "genres", form_add["a" /* default */]), external_react_default.a.createElement("label", {
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__label"
  }, external_react_default.a.createElement("span", {
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__name"
  }, "Influenced authors"), external_react_default.a.createElement("select", {
    onChange: function onChange(e) {
      selectHandler(e, "authors");
    },
    className: "jsx-".concat(form_add["a" /* default */].__hash) + " " + "form-add__input"
  }, external_react_default.a.createElement(external_react_apollo_["Query"], {
    query: queries["d" /* getAuthorsQuery */]
  }, function (_ref3) {
  ...
  }))), mapFromCache(influenceIds, client, "authors", form_add["a" /* default */]), external_react_default.a.createElement("div", {
  ...
  }, formType === "edit-author" ? "Save changes" : "Create author"), external_react_default.a.createElement("button", {
...
/* harmony default export */ var components_AuthorForm_AuthorForm = (Object(external_react_apollo_["compose"])(external_react_apollo_["withApollo"], Object(external_react_apollo_["graphql"])(queries["d" /* getAuthorsQuery */], {
  name: "getAuthorsQuery"
}), Object(external_react_apollo_["graphql"])(queries["f" /* getGenresQuery */], {
  name: "getGenresQuery"
}), Object(external_react_apollo_["graphql"])(queries["a" /* addAuthorQuery */], {
  name: "addAuthorQuery",
  options: {
    refetchQueries: [{
      query: queries["d" /* getAuthorsQuery */]
...
}), Object(external_react_apollo_["graphql"])(queries["j" /* updateAuthorQuery */], {
...
}))(Object(WithCRU["a" /* default */])(Object(external_react_apollo_["withApollo"])(AuthorForm_AuthorForm))));
// EXTERNAL MODULE: ./frontend/components/EmptyTable/EmptyTable.js
var EmptyTable = __webpack_require__(8);

// CONCATENATED MODULE: ./frontend/components/AuthorsTableEdit/AuthorsTableEdit.js
...
var AuthorsTableEdit_AuthorsTableEdit = function AuthorsTableEdit(_ref) {
  var id = _ref.id;
  return external_react_default.a.createElement("div", {
    ...
    var source = data.authors.find(function (author) {
      return author.id === id;
    });
    return external_react_default.a.createElement("table", {
    ...
    }, "Author name"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Influenced authors"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Genres"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Books")), source.length === 0 ? external_react_default.a.createElement(EmptyTable["a" /* default */], {
      name: "authors",
      size: "4"
    }) : external_react_default.a.createElement("tr", {
      key: source.id,
      ...
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, source.name), source.influencedAuthors.length === 0 ? external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "no influenced authors") : external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, external_react_default.a.createElement("table", {
      className: "jsx-".concat(table["a" /* default */].__hash)
    }, external_react_default.a.createElement("tbody", {
      className: "jsx-".concat(table["a" /* default */].__hash)
    }, source.influencedAuthors.map(function (author) {
    ...
    })))), source.genres.length === 0 ? external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "no genres") : external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, external_react_default.a.createElement("table", {
      className: "jsx-".concat(table["a" /* default */].__hash)
    }, external_react_default.a.createElement("tbody", {
      className: "jsx-".concat(table["a" /* default */].__hash)
    }, source.genres.map(function (genre) {
      return external_react_default.a.createElement("tr", {
        key: genre.id,
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, external_react_default.a.createElement("td", {
    ...
    })))), source.books.length === 0 ? external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "no books available") : external_react_default.a.createElement("td", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, external_react_default.a.createElement("table", {
      className: "jsx-".concat(table["a" /* default */].__hash)
    }, external_react_default.a.createElement("tbody", {
...
/* harmony default export */ var components_AuthorsTableEdit_AuthorsTableEdit = (AuthorsTableEdit_AuthorsTableEdit);
// EXTERNAL MODULE: ./frontend/components/WithDelete/WithDelete.js
var WithDelete = __webpack_require__(15);

// CONCATENATED MODULE: ./frontend/components/AuthorsTable/AuthorsTable.js
...
var AuthorsTable_AuthorsTable = function AuthorsTable(_ref) {
  ...
  return external_react_default.a.createElement("div", {
  ...
  }, "Authors"), external_react_default.a.createElement(Popup["a" /* default */], {
    trigger: external_react_default.a.createElement("button", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__add"
    }, "Add author")
  }, external_react_default.a.createElement("div", {
    className: "jsx-".concat(table["a" /* default */].__hash)
  }, external_react_default.a.createElement(components_AuthorForm_AuthorForm, {
    formType: "add-author",
    defaultState: {
      name: "",
      genreIds: new Set(),
    ...
    return external_react_default.a.createElement("table", {
      ...
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Books"), external_react_default.a.createElement("th", {
      className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
    }, "Actions")), source.length === 0 ? external_react_default.a.createElement(EmptyTable["a" /* default */], {
      name: "authors",
      size: "5"
    }) : source.map(function (author) {
      return external_react_default.a.createElement("tr", {
        key: author.id,
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, author.name), author.influencedAuthors.length === 0 ? external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, "no influenced authors") : external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, external_react_default.a.createElement("table", {
        ...
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, author.influencedAuthors.map(function (author) {
        return external_react_default.a.createElement("tr", {
          key: author.id,
          className: "jsx-".concat(table["a" /* default */].__hash)
        }, external_react_default.a.createElement("td", {
      ...
      })))), author.genres.length === 0 ? external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, "no genres") : external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, external_react_default.a.createElement("table", {
        ...
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, author.genres.map(function (genre) {
        return external_react_default.a.createElement("tr", {
          key: genre.id,
          className: "jsx-".concat(table["a" /* default */].__hash)
        }, external_react_default.a.createElement("td", {
      ...
      })))), author.books.length === 0 ? external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, "no books available") : external_react_default.a.createElement("td", {
        className: "jsx-".concat(table["a" /* default */].__hash) + " " + "table__cell"
      }, external_react_default.a.createElement("table", {
        ...
        className: "jsx-".concat(table["a" /* default */].__hash)
      }, external_react_default.a.createElement(components_AuthorsTableEdit_AuthorsTableEdit, {
        id: author.id
      }), external_react_default.a.createElement(components_AuthorForm_AuthorForm, {
        ...
        defaultState: {
          id: author.id,
          name: author.name,
          genreIds: new Set(author.genres.map(function (genre) {
            return genre.id;
          })),
          influenceIds: new Set(author.influencedAuthors.map(function (author) {
            return author.id;
          })),
        ...
        onClick: function onClick(id, queryName) {
          deleteHandler(author.id, "removeAuthorQuery");
        },
...
/* harmony default export */ var components_AuthorsTable_AuthorsTable = (Object(external_react_apollo_["graphql"])(queries["g" /* removeAuthorQuery */], {
...
})(Object(WithDelete["a" /* default */])(AuthorsTable_AuthorsTable)));
...
/* harmony default export */ var authors = __webpack_exports__["default"] = (Object(WithData["a" /* default */])(function () {
  return external_react_default.a.createElement(Layout["a" /* default */], {
    title: "Authors table"
  }, external_react_default.a.createElement(Header["a" /* default */], {
    id: "3"
  }), external_react_default.a.createElement(components_AuthorsTable_AuthorsTable, null));
}));
